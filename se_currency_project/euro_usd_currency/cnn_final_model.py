# -*- coding: utf-8 -*-
"""
Created on Mon Nov 23 23:09:10 2020
...
train_data_dir = 'E:/se_currency_project/euro_usd_currency/training_set'
test_data_dir = 'E:/se_currency_project/euro_usd_currency/test_set'
labels = []
#Nbr of training images
train_samples_nbr  = sum(len(files) for _, _, files in os.walk(r'E:/se_currency_project/euro_usd_currency/training_set'))
#Nbr of testing images
test_samples_nbr  = sum(len(files) for _, _, files in os.walk(r'E:/se_currency_project/euro_usd_currency/test_set'))


nbr_of_pictures = []
labels = os.listdir("E:/se_currency_project/euro_usd_currency/training_set")
for _, _, files in os.walk(r'E:/se_currency_project/euro_usd_currency/training_set'):
...
for i in range(8):  # 82 : Nbr of classes
...
cnn1.add(tf.keras.layers.Dense(units=8, activation='softmax'))
...
#displaying summary of structure of CNN model
cnn1.summary()

#saving .h5 file
cnn1.save('euro_usd_denomination.h5')
...
class_names = ['1','10','100','20','200','5','50','500']
...
test_image = image.load_img('predict/500_euro.jpg', target_size = (64, 64))
